...
const char* thingsboardURL = "https://192.168.1.238:8080/api/v1/EV_CanBUS/telemetry";
...
void setup() {
  ...
  tft.drawGFXText(10, 20, "EV-CAN_BUS", COLOR_YELLOW);
  ...
  WiFiManager wm;
  wm.setTimeout(180);
  if (!wm.autoConnect("EV-CAN_BUSMonitor")) {
  ...
  // OTA Setup
  ArduinoOTA.setHostname("EV-CAN_BUS-Receiver");
  ArduinoOTA.begin();
}
