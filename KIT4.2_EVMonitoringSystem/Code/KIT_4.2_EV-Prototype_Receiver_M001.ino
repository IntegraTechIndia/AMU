...
const char* thingsboardURL = "https://192.168.1.238:8080/api/v1/EV-Prototype/telemetry";
...
void setup() {
  ...
  // -------- WiFiManager --------
  WiFiManager wm;
  if (!wm.autoConnect("EV-Prototype-Receiver")) {
  ...
  // -------- OTA --------
  ArduinoOTA.setHostname("EV-Prototype_Receiver");
  ArduinoOTA.begin();
  ...
  tft.drawGFXText(20, 20, "EV-Prototype", COLOR_YELLOW);
}
