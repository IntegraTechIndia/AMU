...
float R0_MQ7 = 6099.68;
float R0_MQ135 = 6054.65;
...
const char* thingsboardURL = "https://192.168.1.238:8080/api/v1/AirQuality/telemetry";
...
void setup() {
  ...
  tft.drawGFXText(10, 20, "AirQuality", COLOR_YELLOW);
